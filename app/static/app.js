document.addEventListener("DOMContentLoaded", () => {
    ...
    // ── Preset Texts ──────────────────────────────────────────
    const presets = {
        "bm-fake": "TULAR: Saintis temui ubat mujarab untuk sembuhkan kanser dalam masa 48 jam! Rahsia ini disembunyikan oleh syarikat farmaseutikal besar kerana takut kehilangan keuntungan berbilion ringgit. Konspirasi besar sedang berlaku! Sebarkan segera kepada semua kenalan anda sebelum video ini dipadam dan diharamkan oleh kerajaan. Jangan tunggu lagi, nyawa anda mungkin dalam bahaya! Minum air kelapa dicampur halia setiap pagi untuk elak virus merbahaya.",
        "bm-real": "Kementerian Kesihatan Malaysia telah mengesahkan bahawa program vaksinasi kebangsaan fasa ketiga akan bermula pada bulan depan melibatkan kumpulan sasar dalam kalangan warga emas berumur enam puluh tahun ke atas dan individu yang menghidap penyakit kronik seperti kencing manis dan darah tinggi. Ketua Pengarah Kesihatan menyatakan bahawa sebanyak tiga juta dos vaksin telah diterima dan akan diagihkan kepada semua hospital kerajaan dan klinik kesihatan di seluruh negara mengikut kapasiti dan keperluan setiap negeri. Orang ramai digalakkan mendaftar melalui portal rasmi MySejahtera untuk mendapatkan slot vaksinasi.",
        ...
        "mbmb-fake": "Awas penduduk Melaka! MBMB didedahkan sedang merancang untuk merobohkan seluruh kawasan Jonker Street dan mengusir peniaga lama secara paksa tanpa pampasan! Ribuan peniaga akan kehilangan punca rezeki mereka dalam masa dua minggu! Ini angkara projek rahsia yang melibatkan syarikat asing! Sebarkan segera untuk selamatkan warisan Melaka sebelum terlambat! Majlis Bandaraya Melaka Bersejarah tidak peduli nasib rakyat jelata!",
        "mbmb-real": "Majlis Bandaraya Melaka Bersejarah telah melancarkan aplikasi mudah alih rasmi yang membolehkan penduduk membuat aduan berkaitan perkhidmatan perbandaran, memohon lesen perniagaan, dan membayar bil cukai taksiran secara dalam talian tanpa perlu hadir ke pejabat. Lebih daripada sepuluh ribu pengguna telah mendaftar dalam tempoh dua minggu pertama sejak aplikasi dilancarkan oleh pihak berkuasa tempatan bagi meningkatkan kecekapan perkhidmatan awam kepada warga bandar."
    };
